...
class Attendees extends Component {
    constructor(props){
        ...
        this.restQuery = this.restQuery.bind(this);
    ...
    componentDidMount(){
        ...
        ref.on('value', snapshot => {
            ...
            this.setState({displayAttendees: attendeesList, allAttendees: attendeesList});
        })
    }
            ...
            <div className="container mt-4">
                <div className="row justify-content-center">
                    <div className="col-md-8">
                        ...
                        <div className="card bg-light md-4">
                            <div className="card-body text-center">
                                <div className="input-group input-group-lg">
                                    ...
                                    <div className="input-group-append">
                                        ...
                                        <button className="btn btn-sm btn-outline-info" title="Reset Search" onClick={ () => this.restQuery()}>
                                            <FaUndo/>
                                        </button>
                                    </div>
                                </div>
